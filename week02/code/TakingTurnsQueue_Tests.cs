...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: The first person dequeued was Sue instead of Bob. The order of dequeued persons does not match the expected result.
    ...
    // Defect(s) Found: The first person dequeued was Sue instead of Tim. The order of dequeued persons does not match the expected result.
